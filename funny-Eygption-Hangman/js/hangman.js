var movies = [
  ...
  {name:"غبي منه فيه",caption:"المطاوة بتاعتنا اما الفلوس مش بتاعتنا"},
   ...
   {name:"ظرف طارق",caption:"واحد مصري هيشجع ايه ؟ نيجيريا طبعا"},
    ...
    {name:"غبي منه فيه",caption:"شكلك فاهم ينصه"},
    {name:"يا انا يا خالتي",caption:"هات صباره وادفني ي ببلاوي"},
    {name:"فول الصين العظيم",caption:"ياللي على الطياره الحقوني انا اتشفطت"},
    {name:"يا انا يا خالتي",caption:"الحقوني الكونترباص هيموتني "},
    {name:"المصلحة",caption:"يا ام السعد يا ام الزفت "},
    {name:"جعلتني مجرما",caption:"النمره غلط يا عماد"},
    {name:"شركة المرعبين المحدودة",caption:"احنا بنعمل مسرحيه اسمها رجع البتاعه دي والا علينا العوض "},
    {name:"اكس لارج",caption:"مش احنا الي بنجري ده النعش هو الي بيجري "},
    {name:"شركة المرعبين المحدودة",caption:"انت ، ابعد ايدك عن شعنونتي"},
    {name:"كلمني شكرا",caption:"جمل ياباالحج، متخليها تشوفلينا حد من قريبها بس يكون نفس المقاس الفرع ده"},
]
